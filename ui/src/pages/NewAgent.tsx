...
export function NewAgent() {
  ...
  return (
    <div className="mx-auto max-w-2xl space-y-6">
      <div>
        <h1 className="text-lg font-semibold">Новый агент</h1>
        <p className="text-sm text-muted-foreground mt-1">
          Расширенная настройка агента
        </p>
      </div>
      ...
      <div className="border border-border">
        ...
        <div className="px-4 pb-2">
          <input
            ...
            placeholder="Должность (напр. VP of Engineering)"
            value={title}
              ...
              >
                {currentReportsTo ? (
                  <>
                    ...
                    {`Подчиняется ${currentReportsTo.name}`}
                  </>
                ) : (
                  <>
                    <User className="h-3 w-3 text-muted-foreground" />
                    {isFirstAgent ? "Подчиняется: Н/Д (CEO)" : "Подчиняется..."}
                  </>
                )}
              </button>
            </PopoverTrigger>
        ...
        <div className="border-t border-border px-4 py-3">
          {isFirstAgent && (
            <p className="text-xs text-muted-foreground mb-2">Это будет CEO</p>
          )}
          {formError && (
          ...
          <div className="flex items-center justify-end gap-2">
            ...
            >
              {createAgent.isPending ? "Создание…" : "Создать агента"}
            </Button>
          </div>
        </div>
      </div>

...
export function Org() {
  ...
  if (!selectedCompanyId) {
    return <EmptyState icon={GitBranch} message="Выберите компанию для просмотра оргструктуры." />;
  }
  ...
  return (
    <div className="space-y-4">
      ...
      {data && data.length === 0 && (
        <EmptyState
          icon={GitBranch}
          message="Нет агентов в организации. Создайте агентов для построения оргструктуры."
        />
      )}

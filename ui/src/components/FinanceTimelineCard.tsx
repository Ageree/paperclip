  ...
  return (
    <Card>
      <CardHeader className="px-4 pt-4 pb-1">
        <CardTitle className="text-base">Последние финансовые события</CardTitle>
        <CardDescription>Пополнения, комиссии, кредиты, обязательства и другие расходы вне запросов.</CardDescription>
      </CardHeader>
            ...
            >
              <div className="flex items-start justify-between gap-3">
                ...
                <div className="text-right tabular-nums">
                  ...
                  {row.estimated ? <div className="text-[11px] uppercase tracking-[0.12em] text-amber-600">оценочно</div> : null}
                </div>
              </div>
            </div>
          ))

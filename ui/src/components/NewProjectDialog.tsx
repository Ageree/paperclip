...
export function NewProjectDialog() {
  ...
  async function handleSubmit() {
    ...
    if (repoRequired && !isGitHubRepoUrl(repoUrl)) {
      setWorkspaceError("Необходимо указать корректный URL репозитория GitHub.");
      return;
    }
    ...
    >
      ...
      >
        ...
        <div className="px-4 pb-3 space-y-3 border-t border-border">
          <div className="pt-3">
            <p className="text-sm font-medium">Где будет вестись работа над проектом?</p>
            <p className="text-xs text-muted-foreground">Добавьте репозиторий и/или локальную папку для проекта.</p>
          </div>
          <div className="grid gap-2 sm:grid-cols-3">
            ...
            >
              ...
              <p className="mt-1 text-xs text-muted-foreground">Укажите полный путь на этой машине.</p>
            </button>
            <button
              type="button"
              className={cn(
            ...
            >
              ...
              <p className="mt-1 text-xs text-muted-foreground">Вставьте URL GitHub.</p>
            </button>
            <button
              type="button"
              className={cn(
            ...
            >
              ...
              <p className="mt-1 text-xs text-muted-foreground">Настроить репозиторий и локальную папку.</p>
            </button>
          </div>

          {(workspaceSetup === "local" || workspaceSetup === "both") && (
            <div className="rounded-md border border-border p-2">
              <label className="mb-1 block text-xs text-muted-foreground">Локальная папка (полный путь)</label>
          ...
          {(workspaceSetup === "repo" || workspaceSetup === "both") && (
            <div className="rounded-md border border-border p-2">
              <label className="mb-1 block text-xs text-muted-foreground">URL репозитория</label>
              <input
